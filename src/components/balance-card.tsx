...
export function BalanceCard({ totalBalance, income, expense }: BalanceCardProps) {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-5 sm:p-6 text-white shadow-md space-y-4">
