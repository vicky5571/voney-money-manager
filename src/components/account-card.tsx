      ...
      <div className="flex items-center gap-1.5">
        ...
        {onAdjust && (
          <button
            ...
            className="min-h-[44px] min-w-[44px] p-2 hover:bg-gray-100 rounded-xl text-gray-400 hover:text-indigo-600 flex items-center justify-center transition-colors cursor-pointer"
