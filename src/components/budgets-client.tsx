    ...
    <div className="min-h-screen pb-24 relative p-4 space-y-6">
      ...
      <div className="flex items-center justify-between bg-white rounded-2xl p-4 shadow-sm">
        ...
        <div className="text-center">
          ...
          <span className="text-xs text-gray-400">Showing active budgets for this period</span>
        </div>
      ...
      <div className="space-y-4">
        {initialBudgets.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-2xl border border-gray-100 px-4">
            <p className="text-gray-500 font-medium text-sm">No budgets active for this period.</p>
      ...
      {deleteTargetId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          <div className="relative w-full max-w-sm bg-white rounded-3xl p-6 shadow-2xl animate-in zoom-in-95 duration-200 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">Are you sure you want to delete this budget?</p>
          ...
          <div className="relative w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Set category, amount, and custom date range</p>
              </div>
              <button 
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Date Presets */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Duration Presets</label>
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => setPreset('month')}
                    className="flex-1 py-1.5 px-2 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 rounded-lg text-xs font-semibold transition-colors"
                  >
                    This Month
                  </button>
                  <button
